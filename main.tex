...
\begin{enumerate}
    ...
    \item \textbf{RQ4:} What heuristic-based mapping strategies can be utilized to automate the ingestion of inconsistently formatted CSV data into a unified semantic schema?
\end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Automated Ingestion Heuristics:} A flexible CSV processing module that utilizes fuzzy header matching and content-based inference to normalize multi-format user uploads without manual schema mapping.
...
The inclusion of user-provided CSVs introduces additional privacy challenges, particularly concerning Personal Identifiable Information (PII) and data sovereignty.
