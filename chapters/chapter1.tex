...
\item RQ3: How much does a hybrid retrieval strategy---one that combines lexical (BM25) and semantic (vector) search---improve the relevance and recall of internship discovery compared to traditional keyword search alone?
...
\item A Hybrid Search Infrastructure: The thesis implements a retrieval system using an in-memory vector index and BM25 to support hybrid lexical and semantic search.
