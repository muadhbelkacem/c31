...
Our dataset is primarily focused on the Tech and Business sectors within the North American and European contexts, driven by the ESCO framework. The effectiveness of the system might degrade when applied to different linguistic domains or regions with different occupational structures \cite{kurekova2015using}.
