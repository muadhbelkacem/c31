...
The first stage of evaluation focuses on the performance of the rule-based Layer A for structured field extraction.
...
A key goal of this thesis is to demonstrate the feasibility of running a semantic pipeline on commodity hardware.
